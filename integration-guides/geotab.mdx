...
<Note>If your account has operational hours or geospatial restrictions set on the account then we will be only able to collect data when these conditions are met</Note>
