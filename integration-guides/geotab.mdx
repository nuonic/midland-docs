...
<Note>Geotab records some trips that with a metadata of AfterHours. These are trips that take place after any operational hours that are set in an account or outside any Geospatial restrictions that are set on the account. We do not track these trips as they can have incomplete data</Note>

<Note>Geotab includes any idling that takes place after the end of a trip and before the start of the next trip to be part of the current trip. We capture this idling data as a separate trip in our system.</Note>
