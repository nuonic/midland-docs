...
<Note>Geoforce offers Geotab and other devices. PathStack currently offers integration with Geotab only, which can be connected by the following this guide. For other devices, please [contact us](/legal/contact-information) to discuss options.</Note>
