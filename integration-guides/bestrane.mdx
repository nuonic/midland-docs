...
<Note>Bestrane offers Geotab devices for telematics as well as other hardware and software solutions. PathStack currently offers integration with Geotab, which can be connected by the following this guide. For other devices, please [contact us](/legal/contact-information) to discuss options.</Note>
...
<Steps>
  ...
  <Step title="Create a new user for PathStack">
    ...
    <Steps>
      ...
      <Step title = "Security Clearance - Choose View Only" />
